...
class OrdenProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden_producto" do
    assert_difference('OrdenProducto.count') do
      post orden_productos_url, params: { orden_producto: { cantidad: @orden_producto.cantidad, intrucciones: @orden_producto.intrucciones, orden_id: @orden_producto.orden_id, precio: @orden_producto.precio, producto_id: @orden_producto.producto_id } }
    end
  ...
  test "should update orden_producto" do
    patch orden_producto_url(@orden_producto), params: { orden_producto: { cantidad: @orden_producto.cantidad, intrucciones: @orden_producto.intrucciones, orden_id: @orden_producto.orden_id, precio: @orden_producto.precio, producto_id: @orden_producto.producto_id } }
